    ...
    jumpPrevIcon={(
      <a className={styles['jfe-drip-table-pagination-item-link']}>
        <div className={styles['jfe-drip-table-pagination-item-container']}>
          <span role="img" aria-label="double-left" className={styles['jfe-drip-table-pagination-item-link-icon']}>
          ...
          <span className={styles['jfe-drip-table-pagination-item-ellipsis']}>•••</span>
        </div>
      </a>
    )}
    jumpNextIcon={(
