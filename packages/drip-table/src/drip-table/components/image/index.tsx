...
interface DTCImageProps<RecordType extends DripTableRecordTypeBase> extends DripTableComponentProps<RecordType, DTCImageSchema> { }
...
export default class DTCImage<RecordType extends DripTableRecordTypeBase> extends React.PureComponent<DTCImageProps<RecordType>, DTCImageState> {
  public static componentName: 'image' = 'image';
  ...
  public render() {
    const { popover, imageWidth, imageHeight, imagePlaceholder: noDataUrl, preview } = this.props.schema;
    ...
    const imgFragment = (
      <Image
        ...
        height={imageHeight}
        src={this.value}
        preview={this.props.preview ? false : preview}
        fallback={noDataUrl || this.DEFAULT_IMAGE}
      />
    );
