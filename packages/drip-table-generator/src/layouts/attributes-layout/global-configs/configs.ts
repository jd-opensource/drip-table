...
const PaginationAttrConfigs: DTGComponentPropertySchema[] = [
  ...
  },
  {
    ...
    'ui:description': {
      type: 'text',
      trigger: 'hover',
      title: '是否展示分页器页码编号、上一页、下一页按钮的边框',
    },
    'ui:type': 'switch',
    'ui:props': {},
    type: 'boolean',
  ...
  },
  {
    ...
    'ui:description': {
      type: 'text',
      trigger: 'hover',
      title: '是否将分页器展示为简单模式: [current]/totalPage，其余信息均不展示',
    },
    'ui:type': 'switch',
    'ui:props': {},
    type: 'boolean',
...
export const GlobalAttrFormConfigs: DTGComponentPropertySchema[] = [
  ...
  ...FooterAttrConfigs,
  {
    ...
    'ui:type': 'switch',
    'ui:description': {
      title: '设置表格默认开启一列的排序状态，注意只允许一列开启默认排序',
      trigger: 'hover',
      type: 'icon',
    },
    'ui:layout': {
  ...
  },
  {
    ...
    type: 'string',
    default: '',
    visible: (v, formData) => !!formData?.initialSorter,
  },
  {
    name: 'initialSorter.direction',
    group: '默认排序设置',
    'ui:title': '默认排序方向',
    'ui:type': 'select',
    'ui:props': {
      style: { width: '100%' },
      options: [{ label: '升序', value: 'ascend' }, { label: '降序', value: 'descend' }],
    },
    type: 'string',
    default: '',
    visible: (v, formData) => !!formData?.initialSorter,
