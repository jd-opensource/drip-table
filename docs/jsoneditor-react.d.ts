declare module 'jsoneditor-react' {
  export class JsonEditor<T> extends React.Component<JsonEditorProps<T>> {
    public jsonEditor: unknown;
  }
    ...
    interface JsonEditorProps<T> {
      ...
      onClassName?: (args: { path: unknown; field: unknown; value: unknown }) => void;
